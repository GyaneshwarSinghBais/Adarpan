...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, FlatList, SafeAreaView, RefreshControl, ScrollView } from 'react-native';
...
const WHReceiptItems = ({ navigation, props }) => {
  ...
  return (
    ...
    <View style={styles.cardContent}>
          ...
          <View style={[styles.containerGrid,{zIndex:-1, marginTop:-20}]}>
