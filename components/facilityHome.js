...
import PendingToPickDrop from './Parcel/PendingToPickDrop';
import ItemTracking from './Parcel/ItemTracking';
import ItemWiseInHandQty from './Stock/ItemWiseInHandQty';
import DistItemInHandQty from './Warehouse/DistItemInHandQty';
import WHReagentStock from './Reagent/WHReagentStock';
import GenrateQR from './QR/GenerateQR';
import QRCodeReaderPage from './QR/QRCodeReaderPage';
...
export function MyDrawer() {
  ...
  const isqc1 = (informaitonAboutUser.approle == "QC1");
  const isqc2 = (informaitonAboutUser.approle == "QC2");
  ...
  return (
    <Drawer.Navigator
      ...
      {(isqc || ismdcgmscl || isadmin || isqc2 || isgme || isgmt || islogi || ispo || isfin || isProc || isWH || isColl || iscmho) && (<Drawer.Screen name="Warehouse Stock" component={CStock} />)}
      {(isColl || iscmho) && (<Drawer.Screen name="Drug Info" component={WHDistrict} />)} 
      {(ismdcgmscl || isqc || isqc2 || isadmin || isgme || isgmt || istender || islogi || ispo || isProc || isWH) && (<Drawer.Screen name="Group/Item Type Stock" component={GroupItemRCStock} />)}
      {(ismdcgmscl || isqc || isqc2 || isadmin || isgme || isgmt || istender || islogi || ispo || isProc || isWH) && (<Drawer.Screen name="Item Info" component={TableComponent} />)}
      ...
      {(ismdcgmscl || isadmin || isgmt || istender || islogi || ispo || isProc) && (<Drawer.Screen name="AYUSH Status" component={AYUSHStatus} />)}
      {(ismdcgmscl || isadmin || isgme || isgmt || islogi || isProc || isqc2) && (<Drawer.Screen name="Near Expiry" component={Nearexp} />)}
      {(ismdcgmscl || isadmin || isgme || isgmt || islogi || isProc || isWH) && (<Drawer.Screen name="WH Indent Pending" component={IndentPending} />)}
      {(ismdcgmscl || isadmin || isgme || isgmt || islogi  || isWH || ispo || isqc) && (<Drawer.Screen name="Issues in Receipt" component={PipeLineIssueRPT} />)}
      ...
      {(ismdcgmscl || isadmin || isgme || isgmt || istender || islogi || ispo ) && (<Drawer.Screen name="RC/Acceptance" component={RCAcceptanceTotal} />)}
      {(ismdcgmscl || isadmin || isgme || isgmt || istender ) && (<Drawer.Screen name="Tender Stage" component={TenderStage} />)}
      {(ismdcgmscl || isadmin || isgme || isgmt || istender ) && (<Drawer.Screen name="Tender Items" component={TenderEvaluation} />)}
      {(isadmin || isgme || isgmt || istender ) && (<Drawer.Screen name="Tender Alert" component={TenderAlert} />)}
      {(isqc || isqc2 || ismdcgmscl || isadmin || isgme || isgmt) && (<Drawer.Screen name="QC Result Pending(Lab)" component={Timeline} />)}
      {(isqc || isqc2 || isadmin ||  isgmt) && (<Drawer.Screen name="QC Result Pending(HO)" component={FinalUpdate} />)}
      ...
      {(isColl || iscmho) && (<Drawer.Screen name="Hospital's Stock" component={ItemWiseInHandQty} />)} 
      ...
      {(ismdcgmscl || isadmin || isgme) && (<Drawer.Screen name="WH Reagent Stock" component={WHReagentStock} />)}
      {(isqc || ismdcgmscl || isadmin || isgme || isgmt || islogi || ispo || isfin || isProc || isWH  || iscmho || isqc1 || isqc2) && (<Drawer.Screen name="Vehicle Monitoring" component={vehicleMonitor} />)}
      ...
      {(isColl || iscmho) && (<Drawer.Screen name="OPD's Diagnosis" component={Diagnosys} />)}
       
     
      {/* {(isColl || iscmho) && (<Drawer.Screen name="District's Stock" component={DistItemInHandQty} />)}      */}
      {(isqc ||isqc1  || ismdcgmscl || isadmin  || isgmt) && (<Drawer.Screen name="Pending to Pick/Drop" component={PendingToPickDrop} />)}
      {/* {(isqc ||isqc1  || ismdcgmscl || isadmin  || isgmt) && (<Drawer.Screen name="Generate QR" component={GenrateQR} />)}
      {(isqc ||isqc1  || ismdcgmscl || isadmin  || isgmt) && (<Drawer.Screen name="QR Reader" component={QRCodeReaderPage} />)} */}
      {/* {(isqc ||isqc1  || ismdcgmscl || isadmin  || isgmt) && (<Drawer.Screen name="Item Movement Tracking" component={ItemTracking} />)} */}
